...
Solutions:
1. Hard way - to create 2 functions (asc, desc) for different orders and let qsort take additional argument "order"
/THIS ->/2. Medium way - to add external variable reverse and let comp functions check this variable
THIS - > 3. Easy way - to change writeline function to print out lines in reverse order if it's necessary
*/
